...
(function(){
  ...
  var attrs=['data-modele','data-nom','data-citation','data-mention','data-couleur','data-image1','data-image2'];
  ...
  function updateExample(host,root,prefix){
    ...
    lines.push('  <div class="couleur">'+escapeAttribute(data.couleur)+'</div>');
  ...
  function boot(){
    ...
    document.documentElement.setAttribute('data-mm-signatures','1.4.1');
  }
