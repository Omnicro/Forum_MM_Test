...
(function(){
  ...
  var sections={nom:'nom',citation:'citation',texte1:'accroche',texte2:'mention',couleur:'couleur',img1:'image1',img2:'image2'};
  function ensureCss(){
  ...
  function boot(){
    ...
    document.documentElement.setAttribute('data-mm-signatures','1.4');
  }
